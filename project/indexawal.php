...
<div class="headerwrapper">
	<div id="header" class="container">
		<div class="logo"> <a href="indexawal.php"><img src="images/LOGO.png" alt="logo" width="165" height="74"></a> </div> <!--end of Logo-->
        <nav>
            <ul id="navigations">
                <h5><li><a href="indexawal.php">HOME</a></li>
                <li> <a href="#bookonline">REGISTRASI</a></li>
                <li><a href="#map">ORDER</a></li>
                <li><a href="#bestdishes">MENU</a></li>
                <li><a href="#copyrights">CONTACT</a></li>
				<li><a href="#contact">DAFTAR PESAN</a></li>
				<li><a href="menulogin.php">LOGIN</a></li>
				</h5>
            </ul>
        </nav>
      </div> <!--end of header-->
